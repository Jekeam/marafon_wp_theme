		...
		<div class="wrapper">
			...
			<div class="main-box">
				...
				<ul class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a class="home" href="<?php bloginfo('url'); ?>" itemprop="item"><span itemprop="name"><?php echo $bread_crumbs_home; ?></span></a></li>
					<?php if(function_exists('get_parent_of_subcategory')){ if(get_parent_of_subcategory()){ ?>
					<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><?php echo get_parent_of_subcategory() ?></li>
					<?php }} ?>
				</ul>
				<?php } ?>
				<?php if ( is_single() ) {
				...
				<ul class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
					...
					<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo get_category_link($category_post[0]->category_parent); ?>" itemprop="item"><span itemprop="name"><?php echo get_cat_name($category_post[0]->category_parent) ?></span></a></li>
					<?php } ?>
					<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a href="<?php echo get_category_link($category_post[0]->term_id ); ?>" itemprop="item"><span itemprop="name"><?php echo $category_post[0]->cat_name; ?></span></a></li>
				</ul>
				<?php } ?>
